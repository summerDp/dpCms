(function(angular, factory) {
	...
	app.factory('NgTableParams', ['$q', '$log', 'ngTableDefaults', 'ngTableGetDataBcShim', 'ngTableDefaultGetData', 'ngTableEventsChannel',
								...
								for (var subkey in item) {
									if (!angular.isUndefined(item[subkey]) && item[subkey] !== "") {
										...
										if (name == 'sorting') {
											...
											//pname='field='+encodeURIComponent(subkey);

											if (asString) {
												pairs.push("field=" + encodeURIComponent(subkey))
												pairs.push("direction=" + item[subkey]);
											} else {
												pairs['field'] = encodeURIComponent(subkey);
												pairs['direction'] = item[subkey];
											}

											continue;
										} else {
											pname = encodeURIComponent(subkey);
										}
	 ...
	 */
	app.factory('ngTableParams', ['NgTableParams',
	 ...
	 */
	app.directive('ngTableDynamic', ['$parse',
		function($parse) {
