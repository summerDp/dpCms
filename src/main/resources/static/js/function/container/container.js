app.controller('containerCtrl', function($scope, $filter, NgTableParams, $resource, $q, $http, $sce, tableDataService) {
	//初始化请求资源
...
app.directive('containeredit', function() {
	return {
		restrict: 'E',
		scope: {
			item: '=',
		...
		replace: true,
		templateUrl: basePath + '/js/function/container/containerEdit.html',
...
app.directive('containerTypeSelect', function() {
	return {
		restrict: 'E',
		...
		templateUrl: basePath + '/js/function/container/containerTypeSelect.html',
		link: function(scope, element, attrs) {},
		controller: DefaultSelectTableCtrl
	}
});
app.directive('enterpriseSelect', function() {
	return {
		restrict: 'E',
		...
		templateUrl: basePath + '/js/function/container/enterpriseSelect.html',
		link: function(scope, element, attrs) {},
		controller: DefaultSelectTableCtrl
	}
});