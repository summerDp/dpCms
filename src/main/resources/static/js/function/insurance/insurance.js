app.controller('insuranceCtrl', function($scope, $filter, NgTableParams, $resource, $q, $http, $sce, tableDataService) {
		//初始化请求资源
...
app.directive('insuranceedit', function() {
	return {
		restrict : 'E',
		scope : {
			item : '=',
		...
		replace : true,
		templateUrl : basePath + '/js/function/insurance/insuranceEdit.html',
