app.controller('functionCtrl', function($scope, $filter, NgTableParams, $resource, $q, $http, $sce, tableDataService) {
		//初始化请求资源
...
app.directive('functionedit', function() {
	return {
		restrict : 'E',
		scope : {
			item : '=',
		...
		replace : true,
		templateUrl : basePath + '/js/function/function/functionEdit.html',
